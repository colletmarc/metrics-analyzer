        ...
        <form method="post" action="{{ route('apps.update', $app->id) }}">
            ...
            <div class="lg:flex lg:mx-6 px-3 items-center mb-4 mt-8">
                ...
                <div class="lg:w-1/3">
                    ...
                    <input class="appearance-none block w-full bg-gray-800 border border-gray-700 lg:rounded-r-lg lg:rounded-l-none rounded-lg py-3 px-4 mb-4 focus:outline-none" id="app_endpoint" value="{{ $app->metrics_endpoint }}" name="metrics_endpoint">
                </div>
            </div>
